...
| **Scrambl** | Scrmbl is a Java-based encryption and decryption framework that reimagines a previous image-scrambling concept into a text-focused, multi-structure cipher system.
The project demonstrates how different data structures—maps, graphs, and trees—can uniquely drive algorithmic encryption logic. | Coming Soon | https://github.com/zachsarc/scrmbl | Coming soon... |
